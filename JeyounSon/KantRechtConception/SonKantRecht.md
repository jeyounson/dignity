# 칸트의 법(Recht) 관념 ―법이론에 등장하는 '외적 자유' 개념을 중심으로―
...
칸트의 법이론에서 'Recht'는 각자의 자유가 공존가능해지는 조건들의 총체 를 지칭하고 있다. 그리고 각자는 각자의 의사의 사용이 타인의 자유와 공존할 수 있도록 행위해야 한다. 이때 그 행위의 동기가 의무의 동기에 국한될 필요는 없다는 의미에서, 외적2으로 행위하면 족하다. 그리고 보편적 법의 원리에 따라

이러한 조건에 부합하는 행위를 'recht'의 속성을 가진다고 평가할 수 있다. 이를 종합하여 볼 때, 일단 'Recht'의 번역어는 이러한 의미들을 가장 잘 종합하 고 있는, 독자에게 친숙한 하나의 개념으로 통일하여 이해하는 것이 좋다. 우리가 이러한 조건들의 총체 개념에 한국어 '법'을 적용하는데 거부감이 없다면, 일단 'Recht'를 한국어 '법' 혹은 '법적임'과 등치시켜 이해해보고자 하는 것이 나름의 합 리적 선택이 될 것이다. 다만, 앞서의 논의를 통해 밝혔듯, 추후의 해석론은 차치 하고 이 개념 자체를 법률로, 혹은 어떤 외적1 자유의 영역에서 이해할 수는 없다.

또한 이충진 역과 같이 'Recht'를 때로 일종의 올바름으로 이해하고자 한다면, Rechtslehre 전반에 걸쳐 등장하는 'Recht'와 그 파생어들을 어느 정도는 '올바 름'이 지칭하는 의미와 통일적으로 이해하고자 하는 시도가 수반되어야 할 것이 다. 백종현 역의 경우 형용사 'recht'를 번역할 때, 법이론이 지니는 법의 이론, 권리의 이론, 정당성의 이론, 옳음의 이론으로서의 여러 해석가능성을 배제하지 않고, '법적이다'와 함께 '권리가 있다', '정당하다', '옳다'를 병기하는 전략을 취하 였다. 이 경우 독자는, 번역서가 제시하고 있는 해석가능한 후보들 중 가장 타당 한 번역어가 무엇인지 고르듯이 비판적 독해를 해 나간다면, 칸트 법이론의 이해 에 한 발 다가설 수 있을 것이다.

나아가 형용사 'recht'는 서술어로 쓰일 때는 '법적이다'로, 명사를 한정하는 관 형어로 쓰일 때는 '법적인'으로 이해하면 좋을 것이다. 더불어 'Unrecht'는 '불법/ 불법적임'으로 이해하면 될 것이다. 또한 '권리'라는 번역어는 'ein Recht'가 등장 하는 지점에서만 사용하고 가급적 '(das) Recht'의 번역어로 사용하는 것은 지양 하는 것이 좋을 것으로 보인다. 번역서에 '권리'라는 번역이 등장하는 경우 재차 '법/법적임'으로 새겨 독해해 볼 것을 추천한다.
...
둘째로 칸트의 법 개념을 토대로 한 법이론은, 예를 들어 소유권과 같은 법 제도를 정당화함에 있어서 다른 이론이 쉽게 설명하지 못하는 예지적 측면을 잘 설명해 준다. 우리가 한 물건을 소유한다고 할 때, 우리는 그 물건을 직접 점
 ...
 <sup>32)</sup> John Rawls, Political Liberalism, Columbia, 1993.

 <sup>33)</sup> Thomas Pogge, 'Is Kant's Rechtslehre a "Comprehensive Liberalism"?', in Mark Timmons (ed.), Kant's Metaphysics of Morals: Interpretative Essays, Oxford, 2002 참조.

유하고 있지 않을 때에도 나의 것이라고 할 수 있는데, 이는 매우 신비로운 것이 어서 이론적으로 정당화하는 것은 쉽지 않다. 그렇다고 해서 이를 부정하면, 안 정된 소유관계를 토대로 벌어지는 사회의 수많은 거래 안전이 불안정한 비-도 덕적 기반 위에 서게 될 것이다. 예를 들어, 소유권과 같은 법제도의 정당성을 홉스나 흄과 같이 "복지를 목적으로 한 유용성의 원리 또는 … 자연상태에서의 갈등과 위험의 경험으로부터 도출"하려고 한다면 소유권의 예지적 측면은 직 접적으로 정당화되기보다는 필요에 의해 임시적으로 용인되는 데 불과할 것이 다.34) 그러나 칸트는 이러한 소유권의 정당화를 "오로지 순수한 이성법의 원리

로부터 선험적으로 확보"함으로써 진정한 자유의 가치에 귀속시킨다.35) 칸트의 이론의 또다른 중대성은 자유의 가치를 다른 더 상위의 원리에 의존 하지 않고 그 자체로 도덕성의 기초가 되는 본질적인 개념으로 등장시킨다는 데 있다. 그리고 이로부터 타인 간의 관계에 있어 충돌 상황의 해법이 되는 원 리들을 모순율이나 공존가능성과 같은 선험적 전제들로부터 도출해 낸다. 도 덕성은 애초에 이익-최대화를 목표로 이루어질 수 없는데, 칸트는 이를 자유들 간의 조화와 공존가능성을 통하여 확보하고 있다. 이외에도 우리는 다양한 함 축을 칸트의 법이론으로부터 얻을 수 있을 것이다. 그 중 일부는 첨예한 논란을 불러일으키기도 한다. 예를 들어, 누군가는 칸트의 법이론이 법실증주의의 한 정당화를 제공한다고 주장하기도 하고, 다른 누군가는 법의 연원을 초월적인 심 급에서 찾는 기존 자연법론의 비판적 계승이라고 주장하기도 한다.

그러나 본고는 단지 법이론 번역의 다양화를 계기로 삼아 칸트 법이론을 공부하고자 하는 초심자들, 특히 법률가들이 가능한 한 한쪽 편의 해석론을 선 취하지 않고 중립적 기반 위에서 법이론을 쉽게 펼쳐볼 수 있도록 하는 텍스 트 해석을 위한 길잡이의 역할에 충실하고자 했다. 본고가 제시한 외적 자유의 원리에 대한 이해와 'recht'나 'Recht'와 같은 핵심용어의 번역어 문제에 대한 설 명이 법이론 문헌의 독해에 있어 불필요한 오해와 선입견을 배제시켜, 생산 적인 학문적 재생산을 일으킬 수 있도록 하는 중립적인 공유기반을 형성하는 마 중물이 되었기를 기대한다.

- 35) 김준수 (2014), 위의 논문.
 <sup>34)</sup> 김준수 (2014). "칸트의 소유론에 대한 비판적 고찰", 사회와 철학, 28, 252.

#### Ⅰ. 칸트 원문 및 번역서

1. 원문

- Kant, I., Kants gesammelte Schriften, ([AA]: 베를린 학술원판 전집), Königlich Preußische Akademie der Wissenschaften, Berlin: Walter de Gruyter (1902- ).
2. 번역서

Kant, I, 윤리형이상학 정초(백종현 역, 아카넷, 2005). , 순수이성비판2(백종현 역, 아카넷, 2006). , 윤리형이상학(백종현 역, 아카넷, 2012). , 법이론(이충진 역, 이학사, 2013). , 도덕형이상학(이충진/김수배 역, 한길사, 2018).
...
이충진, "칸트 법이론 텍스트 연구", 칸트연구, 28, 2011, 51-70.
...
In addition, this paper deals with the difficulties in translation of core terms, such as 'Recht' and 'recht'. Recht is mainly translated as 'law(法)'. I would like to consider how to understand the term 'Recht' in Kant's Rechtslehre, while looking at the alternative translations 'correctness' and 'rights'.
 ...
 <sup>*</sup> Law Research Institute, Seoul National University.
